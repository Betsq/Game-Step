...
namespace Game_Step.Migrations
{
    ...
    [Migration("20210512095600_updateSliderModel")]
    partial class updateSliderModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Game_Step.Models.Orders.OrderKeysGame", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Game_Step.Models.Slider.AdditionalItemSlider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("MainItemSliderId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MainItemSliderId");

                    b.ToTable("AdditionalItemSliders");
                });

            modelBuilder.Entity("Game_Step.Models.Slider.MainItemSlider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Game_Step.Models.Orders.OrderKeysGame", b =>
                {
                    b.HasOne("Game_Step.Models.Order", "Order")
                        .WithMany("OrderKeysGame")
            ...
            modelBuilder.Entity("Game_Step.Models.Slider.AdditionalItemSlider", b =>
                {
                    ...
                    b.HasOne("Game_Step.Models.Slider.MainItemSlider", "MainItemSlider")
                        .WithMany("AdditionalItem")
                        .HasForeignKey("MainItemSliderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Game");

                    b.Navigation("MainItemSlider");
                });
